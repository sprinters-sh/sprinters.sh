...
{% include h2.html id="on-demand" text="On-demand instances" %}
...
{% include h2.html id="spot" text="Spot instances" %}
...
{% include h3.html id="prerequisite" text="Prerequisite" %}
...
{% include h3.html id="interruptions" text="Designing for interruptions" %}
...
{% include h3.html id="auto" text="Auto-selection"  %}
...
{% include h3.html id="rerun" text="Automatic rerun"  %}
